...
class KDTree
{
  ...
  public:
    ...
    KDTreeNode* Helper(int current, int start, int end);
    int quickSelect(int start, int end, int current, int midDif);
    int quickSelectHelper(int start, int end, int current);
    ...
    Point<Dim> neighborHelper(const Point<Dim>& query, KDTreeNode* root, int current) const;
